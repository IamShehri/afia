  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        raised:
          "0 2px 4px -1px hsl(var(--shadow-color) / 0.06), 0 4px 12px -2px hsl(var(--shadow-color) / 0.10)",
        overlay:
          "0 8px 24px -4px hsl(var(--shadow-color) / 0.14), 0 16px 48px -8px hsl(var(--shadow-color) / 0.18)",
        glow: "0 0 0 1px hsl(var(--primary) / 0.3), 0 0 24px -4px hsl(var(--primary) / 0.4)",
      },
      keyframes: {
        "fade-in": {
          from: { opacity: "0" },
